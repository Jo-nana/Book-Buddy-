...
ActiveRecord::Schema.define(version: 2022_06_08_092800) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "book_id"
    t.boolean "bookclub", default: true
  ...
  create_table "swappings", force: :cascade do |t|
  ...
  add_foreign_key "chatrooms", "books"
